        ...
        <div className='w-full h-screen'>
            <div className="bg-gradient-to-br from-blue-500 to-indigo-300 flex justify-center items-center w-full h-full py-20">
                <div className='w-full'>
                    ...
                    <Link to='/create' className="w-3/6 max-w-xs animate-bounce rounded-lg relative p-4 mx-auto flex text-xl bg-slate-200 text-gray-600 justify-center items-center  mt-10 border-blue-600 hover:bg-blue-200 hover:animate-none border-2">Create a Survey</Link>
                </div>
